...
import urllib.parse
from spotify_recommendation.secrets_keys import api_client_id, api_client_secret, auth_code, redirect_uri
...
def get_auth_token_with_auth_code(auth_code=auth_code, api_client_id=api_client_id, api_client_secret=api_client_secret, redirect_uri=redirect_uri):
